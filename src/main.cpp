...
private:
    ...
    void createRenderPass() {
        ...
        colorAttachment.samples = VulkanInstance::MsaaSamples;
        ...
        depthAttachment.samples = VulkanInstance::MsaaSamples;
    ...
    void createGraphicsPipeline() {
        ...
        multisampling.rasterizationSamples = VulkanInstance::MsaaSamples;
    ...
    VkFormat findSupportedFormat(const std::vector<VkFormat> &candidates, VkImageTiling tiling, VkFormatFeatureFlags features) {
        for (VkFormat format: candidates) {
            ...
            vkGetPhysicalDeviceFormatProperties(instance->PhysicalDeviceHandle(), format, &props);
